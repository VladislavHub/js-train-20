...
Car.prototype.accelerate.amount = 50

// Використовуємо методи для гальмування та передаємо 20
Car.prototype.brake.amount = 30
/*
...
const specific = function (number){
  if(number > towingCapacity){
...
const truck = new Truck("Toyota", "Tundra", 2019, 20000, "Red", "V8", 10000, "Gasoline", "Automatic", 4, 5600, )
